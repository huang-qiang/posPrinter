...
public abstract class ConverterKit {
	 ...
	 *            转换器
	 */
	public abstract void registConverter(Set<Class<? extends Converter<?>>> converters);
	...
	private Converter<?> matchConverter(Convertable printable) throws PrinterException {
		if(printable==null) {
			Log.d("PRINTER", "printable null");
			return null;
		}
		if(printable.getClass()==null) {
			Log.d("PRINTER", "printable.getClass null");
			return null;
		}
		if(convertMap==null) {
			Log.d("PRINTER", "convertMap null");
			return null;
		}
