...
public class ImageUtils {
     ...
     * @return
     */
	public static byte px2Byte(int x, int y, int image_width, int[] src_bitData) {
		byte b;		
		int pos = y * image_width + x;
		if(pos>= src_bitData.length) {
			Log.d("PRINTER", "x:"+x+" y:"+y+" width:"+image_width+" pos:"+pos);
			return 0;
		}
		int pixel = src_bitData[pos];
